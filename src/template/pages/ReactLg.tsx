        ...
        <>
            ...
            <p> PREMIER PAS EN REACT :
                ...
                <div className='flex justify-center flex-wrap gap-6 my-8'>
                    <img alt="html image example" src="../src/assets/picture/node.jpeg" />
                    <img alt="html image example" src="../src/assets/picture/tailwind.png" />
                    <img alt="html image example" src="../src/assets/picture/react.png" />
                </div>
            ...
            <p> STRUCTURE :
                ...
                <div className='flex justify-center'>
                    <img alt="html image example" src="../src/assets/picture/atomiquedesign.jpeg" />
                </div>
            </p>
            <br />
            <p> CONCLUSION :
