...
var t = function() {
  return t = Object.assign || function(e2) {
    for (var n, t2 = 1, o2 = arguments.length; t2 < o2; t2++) for (var r2 in n = arguments[t2]) Object.prototype.hasOwnProperty.call(n, r2) && (e2[r2] = n[r2]);
    return e2;
  }, t.apply(this, arguments);
};
function o(e2, n, t2, o2) {
  return new (t2 || (t2 = Promise))(function(r2, i2) {
    ...
    function c2(e3) {
      var n2;
      e3.done ? r2(e3.value) : (n2 = e3.value, n2 instanceof t2 ? n2 : new t2(function(e4) {
        e4(n2);
      })).then(a2, l2);
    }
    c2((o2 = o2.apply(e2, n || [])).next());
  });
}
function r(e2, n) {
  var t2, o2, r2, i2 = { label: 0, sent: function() {
  ...
  function l2(l3) {
    return function(c2) {
      return function(l4) {
        ...
        for (; a2 && (a2 = 0, l4[0] && (i2 = 0)), i2; ) try {
          if (t2 = 1, o2 && (r2 = 2 & l4[0] ? o2.return : l4[0] ? o2.throw || ((r2 = o2.return) && r2.call(o2), 0) : o2.next) && !(r2 = r2.call(o2, l4[1])).done) return r2;
          switch (o2 = 0, r2 && (l4 = [2 & l4[0], r2.value]), l4[0]) {
            case 0:
            case 1:
              r2 = l4;
              break;
...
!function(e2, n) {
  ...
  if ("undefined" != typeof document) {
    ...
    r2.type = "text/css", "top" === t2 && o2.firstChild ? o2.insertBefore(r2, o2.firstChild) : o2.appendChild(r2), r2.styleSheet ? r2.styleSheet.cssText = e2 : r2.appendChild(document.createTextNode(e2));
  }
...
var l = function(n) {
  var t2 = n.children;
  return e.createElement(a.Provider, { value: i }, t2);
};
var c = { dark: { themeBGColor: "#022833", themeToolbarColor: "#131519", themeColor: "#839496", themePromptColor: "#a917a8" }, light: { themeBGColor: "#fdf6e4", themeToolbarColor: "#d8d8d8", themeColor: "#333333", themePromptColor: "#a917a8" }, dracula: { themeBGColor: "#272B36", themeToolbarColor: "#DBDBDB", themeColor: "#FFFEFC", themePromptColor: "#a917a8" }, "material-dark": { themeBGColor: "#151515", themeToolbarColor: "#424242", themeColor: "#fff", themePromptColor: "#42A5F5" }, "material-light": { themeBGColor: "#fafafa", themeToolbarColor: "#424242", themeColor: "#151515", themePromptColor: "#42A5F5" }, "material-ocean": { themeBGColor: "#263238", themeToolbarColor: "#37474F", themeColor: "#fff", themePromptColor: "#C3D82C" }, matrix: { themeBGColor: "#0D0208", themeToolbarColor: "#0D0208", themeColor: "#00FF41", themePromptColor: "#008F11" } };
var s = e.createContext(null);
var u = function(n) {
  var o2 = n.children, r2 = t(t({}, c), o2.props.themes || {}), i2 = r2[o2.props.theme] || r2.light;
  return e.createElement(s.Provider, { value: i2 }, o2);
};
var m = function() {
  function e2() {
  }
  return e2.splitStringAtIndex = function(e3, n) {
    return e3 ? [e3.substring(0, n), e3.substring(n)] : ["", ""];
  }, e2.isMobile = function() {
    return UAParser(window.navigator.userAgent).device.is("mobile");
  }, e2;
}();
function d(n) {
  var t2 = e.useContext(a), o2 = n.controlButtonLabels, r2 = n.showControlButtons ? o2.map(function(n2) {
    return e.createElement("div", { key: n2, className: "".concat(t2.consoleCtrl, " ").concat(t2[n2]) });
  }) : null;
  return e.createElement("div", { className: t2.controls }, r2);
}
var f = e.createContext({ bufferedContent: "", temporaryContent: "", setBufferedContent: function(e2) {
}, setTemporaryContent: function(e2) {
...
var p = function(n, t2, i2, l2, c2, u2, d2, p2) {
  var _2 = e.useContext(a), h2 = e.useContext(s), x2 = e.useContext(f), g2 = x2.appendCommandToHistory, C2 = x2.temporaryContent, v2 = e.useRef(null), b2 = e.useState(""), y = b2[0], E = b2[1], w = e.useState(false), T = w[0], S = w[1], k = e.useState(0), B = k[0], F = k[1], D = e.useState(""), N = D[0], A = D[1], P = e.useState(""), I = P[0], X = P[1];
  e.useEffect(function() {
    m.isMobile();
  }, [t2]), e.useEffect(function() {
    T && g2(y);
  }, [T]), e.useEffect(function() {
    null !== p2.current && null !== v2.current && (p2.current.onclick = function() {
      v2.current.focus();
    });
  }, []);
  var z = m.isMobile() && u2 ? e.createElement("div", { className: _2.mobileInput }, e.createElement("input", { type: "text", autoComplete: "off", autoCorrect: "off", autoCapitalize: "off", spellCheck: "false", value: y, onChange: function(e2) {
    return E(e2.target.value);
  }, ref: v2, "data-testid": "editor-input" })) : null, J = T ? e.createElement(e.Fragment, null, z, e.createElement("div", { className: _2.lineText }, t2 && n ? e.createElement("span", { className: _2.caret }, e.createElement("span", { className: _2.caretAfter, style: { background: h2.themeColor } })) : null, e.createElement("span", { className: _2.preWhiteSpace }, C2))) : e.createElement(e.Fragment, null, z, e.createElement("span", { style: { color: h2.themePromptColor } }, i2), e.createElement("div", { className: _2.lineText }, e.createElement("span", { className: _2.preWhiteSpace }, N), t2 && n ? e.createElement("span", { className: _2.caret }, e.createElement("span", { className: _2.caretAfter, style: { background: h2.themeColor } })) : null, e.createElement("span", { className: _2.preWhiteSpace }, I)));
  return function(n2, t3, o2, r2, i3, a2, l3, c3, s2, u3) {
    var d3 = e.useContext(f), p3 = d3.getPreviousCommand, _3 = d3.getNextCommand, h3 = function(e2) {
      if (n2 && s2) {
        e2.preventDefault();
        var l4 = e2.key;
        if ("Enter" !== l4) {
          var c4 = null;
          if ("Backspace" === l4) {
            var d4 = m.splitStringAtIndex(t3, i3), f2 = d4[0], h4 = d4[1];
            c4 = f2.slice(0, -1) + h4, t3 && 0 !== t3.length && a2(i3 - 1);
          } else if ("ArrowUp" === l4) (c4 = p3()) && a2(c4.length);
          else if ("ArrowDown" === l4) c4 = _3(), a2(c4 ? c4.length : 0);
          else if ("ArrowLeft" === l4) i3 > 0 && a2(i3 - 1), c4 = t3;
          else if ("ArrowRight" === l4) i3 < t3.length && a2(i3 + 1), c4 = t3;
          else if ("Tab" === l4) {
            var x3 = Object.keys(u3).find(function(e3) {
              return e3.substring(0, t3.length) === t3;
            });
            if (x3) return o2(x3), void a2(x3.length);
          } else if ((e2.metaKey || e2.ctrlKey) && "v" === l4.toLowerCase()) navigator.clipboard.readText().then(function(e3) {
            var n3 = m.splitStringAtIndex(t3 || "", i3), r3 = n3[0], l5 = n3[1];
            c4 = r3 + e3 + l5, a2(i3 + e3.length), o2(c4);
          });
          else if ((e2.metaKey || e2.ctrlKey) && "c" === l4.toLowerCase()) {
            var g3 = window.getSelection().toString();
            navigator.clipboard.writeText(g3).then(function() {
              o2(c4 = t3);
            });
          } else if (l4 && 1 === l4.length) {
            var C3 = m.splitStringAtIndex(t3, i3);
            f2 = C3[0], h4 = C3[1], c4 = f2 + l4 + h4, a2(i3 + 1);
          } else c4 = t3;
          o2(c4), r2(false);
        } else r2(true);
      }
    ...
    e.useEffect(function() {
      return document.addEventListener("keydown", h3), function() {
        document.removeEventListener("keydown", h3);
      };
    }), e.useEffect(function() {
      var e2 = m.splitStringAtIndex(t3, i3), n3 = e2[0], o3 = e2[1];
      l3(n3), c3(o3);
    }, [t3, i3]);
  }(t2, y, E, S, B, F, A, X, u2, l2), function(n2, t3, i3, l3, c3, u3, m2, d3, p3, _3, h3) {
    var x3 = e.useContext(f);
    x3.bufferedContent;
    var g3 = x3.setBufferedContent, C3 = x3.setTemporaryContent;
    e.useContext(a);
    var v3 = e.useContext(s);
    e.useEffect(function() {
      var a2;
      n2 && (a2 = l3, o(void 0, void 0, void 0, function() {
        var n3, o2, s2, f2, x4, b3, y2, E2;
        return r(this, function(r2) {
          switch (r2.label) {
            case 0:
              return n3 = a2.trim().split(" "), o2 = n3[0], s2 = n3.slice(1), f2 = "", "clear" === o2 ? (g3(""), c3(""), t3(false), u3(0), m2(""), d3(""), [2]) : (x4 = e.createElement(e.Fragment, null, e.createElement("span", { style: { color: v3.themePromptColor } }, i3, " "), e.createElement("span", null, l3), e.createElement("br", null)), g3(function(n4) {
                return e.createElement(e.Fragment, null, n4, x4);
              }), c3(""), u3(0), m2(""), d3(""), a2 ? (b3 = s2.join(" "), o2 && p3[o2] ? "function" != typeof (y2 = p3[o2]) ? [3, 2] : [4, y2(b3)] : [3, 4]) : [3, 9]);
            case 1:
              return f2 = r2.sent(), [3, 3];
            case 2:
              f2 = y2, r2.label = 3;
            case 3:
              return [3, 9];
            case 4:
              return "function" != typeof h3 ? [3, 6] : [4, h3(o2, b3)];
            case 5:
              return f2 = r2.sent(), [3, 9];
            case 6:
              return "function" != typeof _3 ? [3, 8] : [4, _3(o2, b3)];
            case 7:
              return f2 = r2.sent(), [3, 9];
            case 8:
              f2 = _3, r2.label = 9;
            case 9:
              return E2 = e.createElement(e.Fragment, null, f2 ? e.createElement("span", null, f2, e.createElement("br", null)) : null), g3(function(n4) {
                return e.createElement(e.Fragment, null, n4, E2);
              }), C3(""), t3(false), [2];
          }
        });
      }));
    }, [n2]);
  }(T, S, i2, y, E, F, A, X, l2, c2, d2), J;
};
function _(n) {
  var t2 = e.useRef(null), o2 = e.useContext(a), r2 = e.useContext(s), i2 = e.useContext(f).bufferedContent;
  !function(n2, t3) {
    e.useEffect(function() {
      t3.current && (t3.current.scrollTop = t3.current.scrollHeight);
    }, [n2]);
  }(i2, t2);
  var l2 = n.enableInput, c2 = n.caret, u2 = n.consoleFocused, m2 = n.prompt, d2 = n.commands, _2 = n.welcomeMessage, h2 = n.errorMessage, x2 = n.showControlBar, g2 = n.defaultHandler, C2 = p(c2, u2, m2, d2, h2, l2, g2, t2);
  return e.createElement("div", { id: "terminalEditor", ref: t2, className: "".concat(o2.editor, " ").concat(x2 ? null : o2.curvedTop, " ").concat(x2 ? o2.editorWithTopBar : null), style: { background: r2.themeBGColor } }, _2, i2, C2);
}
var h = function(n) {
  var t2, o2, r2, i2, l2 = n.enableInput, c2 = void 0 === l2 || l2, u2 = n.caret, f2 = void 0 === u2 || u2, p2 = n.theme, h2 = void 0 === p2 ? "light" : p2, x2 = n.showControlBar, g2 = void 0 === x2 || x2, C2 = n.showControlButtons, v2 = void 0 === C2 || C2, b2 = n.controlButtonLabels, y = void 0 === b2 ? ["close", "minimize", "maximize"] : b2, E = n.prompt, w = void 0 === E ? ">>>" : E, T = n.commands, S = void 0 === T ? {} : T, k = n.welcomeMessage, B = void 0 === k ? "" : k, F = n.errorMessage, D = void 0 === F ? "not found!" : F, N = n.defaultHandler, A = void 0 === N ? null : N, P = e.useRef(null), I = e.useState(!m.isMobile()), X = I[0], z = I[1], J = e.useContext(a), j = e.useContext(s);
  t2 = P, o2 = X, r2 = z, i2 = function(e2) {
    t2.current && !t2.current.contains(e2.target) ? r2(false) : m.isMobile() ? r2(!o2) : r2(true);
  }, e.useEffect(function() {
    return document.addEventListener("mousedown", i2), function() {
      document.removeEventListener("mousedown", i2);
    };
  });
  var M = g2 ? e.createElement(d, { consoleFocused: X, showControlButtons: v2, controlButtonLabels: y }) : null, L = e.createElement(_, { caret: f2, consoleFocused: X, prompt: w, commands: S, welcomeMessage: B, errorMessage: D, enableInput: c2, showControlBar: g2, defaultHandler: A });
  return e.createElement("div", { ref: P, id: J.terminalContainer, className: J["theme--".concat(h2)], "data-testid": "terminal" }, e.createElement("div", { className: "".concat(J.terminal), style: { background: j.themeToolbarColor, color: j.themeColor } }, M, L));
};
function x(n) {
  var t2 = n.children;
  return e.createElement(l, null, e.createElement(u, null, t2));
}
function g(n) {
  return e.createElement(x, null, e.createElement(h, t({}, n)));
}
var C = function(n) {
  var t2 = n.children, o2 = e.useState(""), r2 = o2[0], i2 = o2[1], a2 = e.useState(""), l2 = a2[0], c2 = a2[1], s2 = e.useState([]), u2 = s2[0], m2 = s2[1], d2 = e.useState(null), p2 = d2[0], _2 = d2[1];
  e.useEffect(function() {
    _2(u2.length);
  }, [u2]);
  return e.createElement(f.Provider, { value: { bufferedContent: r2, temporaryContent: l2, setTemporaryContent: c2, setBufferedContent: i2, appendCommandToHistory: function(e2) {
    e2 && m2(u2.concat(e2));
  }, getPreviousCommand: function() {
    if (0 === p2) return 0 === u2.length ? "" : u2[0];
    var e2 = u2[p2 - 1];
    return p2 > 0 && _2(p2 - 1), e2;
  }, getNextCommand: function() {
    if (p2 + 1 <= u2.length) {
      var e2 = u2[p2 + 1];
      return _2(p2 + 1), e2;
...
var v = f;
var b = { ReactTerminal: g, TerminalContextProvider: C, TerminalContext: v };
export {
  g as ReactTerminal,
  v as TerminalContext,
  C as TerminalContextProvider,
  b as default
};
